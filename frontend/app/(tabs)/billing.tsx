...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 16, color: COLORS.text, ...(Platform.OS === "web" ? ({ outlineStyle: "none" } as any) : {}) },
  ...
  resName: { ...TYPE.title, color: COLORS.text },
  resMeta: { ...TYPE.caption, color: COLORS.textSecondary, marginTop: 2 },
  resTagRow: { flexDirection: "row", gap: 8, marginTop: 8, alignItems: "center" },
  stockTag: {
    fontSize: 11,
    fontWeight: "700",
  ...
  stockTagLow: { color: COLORS.dangerDark, backgroundColor: COLORS.dangerBg },
  mrpTag: { fontSize: 14, fontWeight: "800", color: COLORS.text },
  addBtn: {
    width: 42,
    height: 42,
    borderRadius: RADIUS.md,
  ...
  cartHeader: { ...TYPE.overline, color: COLORS.textSecondary },
  ...
  bottomBar: {
    ...
    gap: SPACING.md,
    ...(Platform.OS === "web"
      ? ({ boxShadow: "0 -2px 16px rgba(16,24,64,0.06)" } as any)
      : {
          shadowColor: "#101840",
  ...
  totalAmount: { fontSize: 26, fontWeight: "900", color: COLORS.text, letterSpacing: -0.6, marginTop: 2 },
  payBtn: {
    minHeight: 56,
    minWidth: 168,
    backgroundColor: COLORS.primaryContainer,
  ...
  payBtnText: { color: COLORS.white, fontSize: 16, fontWeight: "800", letterSpacing: -0.1 },
  modalOverlay: {
    flex: 1,
